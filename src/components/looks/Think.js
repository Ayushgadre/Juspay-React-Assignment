...
const ThinkMessage = ({ character, comp_id }) => {
  // State to manage the think message display and content
  ...
  /* Function to display Think Message */
      ...
      <div className="rounded text-center bg-purple-700 p-2 my-3">
        ...
        <div className="grid grid-cols-2 my-2">
          ...
          <input
            ...
            }} // Update message content on input change
          />
        </div>
        <div
          id={comp_id}
...
export default connect(mapStateToProps)(ThinkMessage); // Connect the component to Redux store
